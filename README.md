...
### v1.5.0 (2026-03-22)
- **货币系统重构**：新增五级货币体系（文、铜、银、金、饼），1000进制换算
- **集市店铺系统**：每个街道新增209个店铺，支持网格布局显示
- **店铺标记功能**：右键标记店铺（黄/绿/红/蓝），已访问店铺字体变淡
- **店铺详情弹窗**：可拖动标题栏移动弹窗，新增留言板功能框架
- **加成总览页面**：左侧导航新增加成页面，显示收入/速度/战斗/套装加成
- **物品管理器**：统一物品添加接口，支持 JSON 格式批量注册物品
- **导航优化**：集市移至概览下方，移除背包"售"按钮
