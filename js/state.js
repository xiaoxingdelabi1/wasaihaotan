const State = {
    ...
    reset() {
        ...
        this.automationCards = [];
        this.automationLinks = [];
        this.automationNextId = 1;
        this.logs = [];
    ...
    getSaveData() {
        return {
            ...
            automationNextId: this.automationNextId || 1
        };
    },
    ...
    loadSaveData(data) {
        ...
        this.automationNextId = data.automationNextId || 1;
        if (data.maxCoins) {
        ...
        if (data.character) {
            ...
            if (!Character.equipment) {
                ...
                if (!Character.equipment.tools) Character.equipment.tools = [];
            }
